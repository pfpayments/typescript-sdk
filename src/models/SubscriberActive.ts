 ...
 */
export function instanceOfSubscriberActive(value: object): value is SubscriberActive {
    if (!('version' in value) || value['version'] === undefined) return false;
    return true;
}

export function SubscriberActiveFromJSON(json: any): SubscriberActive {
    return SubscriberActiveFromJSONTyped(json, false);
}

export function SubscriberActiveFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriberActive {
    if (json == null) {
        return json;
    }
    return {
