 ...
 */
export function instanceOfPaymentProcessorListResponse(value: object): value is PaymentProcessorListResponse {
    return true;
}

export function PaymentProcessorListResponseFromJSON(json: any): PaymentProcessorListResponse {
    return PaymentProcessorListResponseFromJSONTyped(json, false);
}

export function PaymentProcessorListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaymentProcessorListResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PaymentProcessorListResponseToJSON(json: any): PaymentProcessorListResponse {
    return PaymentProcessorListResponseToJSONTyped(json, false);
}

export function PaymentProcessorListResponseToJSONTyped(value?: Omit<PaymentProcessorListResponse, 'data'|'hasMore'|'limit'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
