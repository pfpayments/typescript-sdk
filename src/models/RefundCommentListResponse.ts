 ...
 */
export function instanceOfRefundCommentListResponse(value: object): value is RefundCommentListResponse {
    return true;
}

export function RefundCommentListResponseFromJSON(json: any): RefundCommentListResponse {
    return RefundCommentListResponseFromJSONTyped(json, false);
}

export function RefundCommentListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RefundCommentListResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(RefundCommentFromJSON)),
