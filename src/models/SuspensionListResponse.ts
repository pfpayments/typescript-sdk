 ...
 */
export function instanceOfSuspensionListResponse(value: object): value is SuspensionListResponse {
    return true;
}

export function SuspensionListResponseFromJSON(json: any): SuspensionListResponse {
    return SuspensionListResponseFromJSONTyped(json, false);
}

export function SuspensionListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuspensionListResponse {
    if (json == null) {
        return json;
    }
    return {
