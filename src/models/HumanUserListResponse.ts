 ...
 */
export function instanceOfHumanUserListResponse(value: object): value is HumanUserListResponse {
    return true;
}

export function HumanUserListResponseFromJSON(json: any): HumanUserListResponse {
    return HumanUserListResponseFromJSONTyped(json, false);
}

export function HumanUserListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HumanUserListResponse {
    if (json == null) {
        return json;
    }
    return {
