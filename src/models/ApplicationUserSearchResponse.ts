 ...
 */
export function instanceOfApplicationUserSearchResponse(value: object): value is ApplicationUserSearchResponse {
    return true;
}

export function ApplicationUserSearchResponseFromJSON(json: any): ApplicationUserSearchResponse {
    return ApplicationUserSearchResponseFromJSONTyped(json, false);
}

export function ApplicationUserSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApplicationUserSearchResponse {
    if (json == null) {
        return json;
    }
    return {
