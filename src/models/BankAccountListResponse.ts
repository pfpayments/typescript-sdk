 ...
 */
export function instanceOfBankAccountListResponse(value: object): value is BankAccountListResponse {
    return true;
}

export function BankAccountListResponseFromJSON(json: any): BankAccountListResponse {
    return BankAccountListResponseFromJSONTyped(json, false);
}

export function BankAccountListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BankAccountListResponse {
    if (json == null) {
        return json;
    }
    return {
