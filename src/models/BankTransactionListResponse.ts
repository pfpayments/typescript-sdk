 ...
 */
export function instanceOfBankTransactionListResponse(value: object): value is BankTransactionListResponse {
    return true;
}

export function BankTransactionListResponseFromJSON(json: any): BankTransactionListResponse {
    return BankTransactionListResponseFromJSONTyped(json, false);
}

export function BankTransactionListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BankTransactionListResponse {
    if (json == null) {
        return json;
    }
    return {
