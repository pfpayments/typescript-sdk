 ...
 */
export function instanceOfRefundCommentSearchResponse(value: object): value is RefundCommentSearchResponse {
    return true;
}

export function RefundCommentSearchResponseFromJSON(json: any): RefundCommentSearchResponse {
    return RefundCommentSearchResponseFromJSONTyped(json, false);
}

export function RefundCommentSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RefundCommentSearchResponse {
    if (json == null) {
        return json;
    }
    return {
