 ...
 */
export function instanceOfChargeFlowSearchResponse(value: object): value is ChargeFlowSearchResponse {
    return true;
}

export function ChargeFlowSearchResponseFromJSON(json: any): ChargeFlowSearchResponse {
    return ChargeFlowSearchResponseFromJSONTyped(json, false);
}

export function ChargeFlowSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChargeFlowSearchResponse {
    if (json == null) {
        return json;
    }
    return {
