 ...
 */
export function instanceOfMetricUsageReportSearchResponse(value: object): value is MetricUsageReportSearchResponse {
    return true;
}

export function MetricUsageReportSearchResponseFromJSON(json: any): MetricUsageReportSearchResponse {
    return MetricUsageReportSearchResponseFromJSONTyped(json, false);
}

export function MetricUsageReportSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetricUsageReportSearchResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(SubscriptionMetricUsageReportFromJSON)),
...
export function MetricUsageReportSearchResponseToJSON(json: any): MetricUsageReportSearchResponse {
    return MetricUsageReportSearchResponseToJSONTyped(json, false);
}

export function MetricUsageReportSearchResponseToJSONTyped(value?: Omit<MetricUsageReportSearchResponse, 'data'|'offset'|'hasMore'|'limit'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
