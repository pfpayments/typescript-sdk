 ...
 * 
 * @export
 * @interface ConditionTypeSearchResponse
 */
export interface ConditionTypeSearchResponse {
    /**
     * An array containing the actual response objects.
     * @type {Array<ConditionType>}
     * @memberof ConditionTypeSearchResponse
     */
 ...
 */
export function instanceOfConditionTypeSearchResponse(value: object): value is ConditionTypeSearchResponse {
    return true;
}

export function ConditionTypeSearchResponseFromJSON(json: any): ConditionTypeSearchResponse {
    return ConditionTypeSearchResponseFromJSONTyped(json, false);
}

export function ConditionTypeSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConditionTypeSearchResponse {
    if (json == null) {
        return json;
    }
    return {
