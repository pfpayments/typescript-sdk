...
export function PaymentConnectorConfigurationSearchResponseToJSON(value?: Omit<PaymentConnectorConfigurationSearchResponse, 'data'|'offset'|'hasMore'|'limit'> | null): any {
    if (value == null) {
        return value;
    }
    return {
