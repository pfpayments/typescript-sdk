 ...
 */
export function instanceOfDocumentTemplateTypeSearchResponse(value: object): value is DocumentTemplateTypeSearchResponse {
    return true;
}

export function DocumentTemplateTypeSearchResponseFromJSON(json: any): DocumentTemplateTypeSearchResponse {
    return DocumentTemplateTypeSearchResponseFromJSONTyped(json, false);
}

export function DocumentTemplateTypeSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentTemplateTypeSearchResponse {
    if (json == null) {
        return json;
    }
    return {
