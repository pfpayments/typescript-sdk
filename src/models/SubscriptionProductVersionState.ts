...
export function SubscriptionProductVersionStateToJSONTyped(value: any, ignoreDiscriminator: boolean): SubscriptionProductVersionState {
    return value as SubscriptionProductVersionState;
}
