 ...
 */
export function instanceOfCurrencyBankAccountSearchResponse(value: object): value is CurrencyBankAccountSearchResponse {
    return true;
}

export function CurrencyBankAccountSearchResponseFromJSON(json: any): CurrencyBankAccountSearchResponse {
    return CurrencyBankAccountSearchResponseFromJSONTyped(json, false);
}

export function CurrencyBankAccountSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CurrencyBankAccountSearchResponse {
    if (json == null) {
        return json;
    }
    return {
