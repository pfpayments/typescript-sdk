 ...
 */
export function instanceOfSubscriptionChargeListResponse(value: object): value is SubscriptionChargeListResponse {
    return true;
}

export function SubscriptionChargeListResponseFromJSON(json: any): SubscriptionChargeListResponse {
    return SubscriptionChargeListResponseFromJSONTyped(json, false);
}

export function SubscriptionChargeListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriptionChargeListResponse {
    if (json == null) {
        return json;
    }
    return {
