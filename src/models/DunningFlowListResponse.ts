 ...
 */
export function instanceOfDunningFlowListResponse(value: object): value is DunningFlowListResponse {
    return true;
}

export function DunningFlowListResponseFromJSON(json: any): DunningFlowListResponse {
    return DunningFlowListResponseFromJSONTyped(json, false);
}

export function DunningFlowListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DunningFlowListResponse {
    if (json == null) {
        return json;
    }
    return {
