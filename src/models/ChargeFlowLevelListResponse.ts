 ...
 * 
 * @export
 * @interface ChargeFlowLevelListResponse
 */
export interface ChargeFlowLevelListResponse {
    /**
     * An array containing the actual response objects.
     * @type {Array<ChargeFlowLevel>}
     * @memberof ChargeFlowLevelListResponse
     */
...
/**
 * Check if a given object implements the ChargeFlowLevelListResponse interface.
 */
export function instanceOfChargeFlowLevelListResponse(value: object): value is ChargeFlowLevelListResponse {
    return true;
}

export function ChargeFlowLevelListResponseFromJSON(json: any): ChargeFlowLevelListResponse {
    return ChargeFlowLevelListResponseFromJSONTyped(json, false);
}

export function ChargeFlowLevelListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChargeFlowLevelListResponse {
    if (json == null) {
        return json;
    }
    return {
