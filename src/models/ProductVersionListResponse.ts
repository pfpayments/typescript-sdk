 ...
 */
export function instanceOfProductVersionListResponse(value: object): value is ProductVersionListResponse {
    return true;
}

export function ProductVersionListResponseFromJSON(json: any): ProductVersionListResponse {
    return ProductVersionListResponseFromJSONTyped(json, false);
}

export function ProductVersionListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductVersionListResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ProductVersionListResponseToJSON(json: any): ProductVersionListResponse {
    return ProductVersionListResponseToJSONTyped(json, false);
}

export function ProductVersionListResponseToJSONTyped(value?: Omit<ProductVersionListResponse, 'data'|'hasMore'|'limit'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
