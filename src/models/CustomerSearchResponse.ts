 ...
 */
export function instanceOfCustomerSearchResponse(value: object): value is CustomerSearchResponse {
    return true;
}

export function CustomerSearchResponseFromJSON(json: any): CustomerSearchResponse {
    return CustomerSearchResponseFromJSONTyped(json, false);
}

export function CustomerSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerSearchResponse {
    if (json == null) {
        return json;
    }
    return {
