 ...
 */
export function instanceOfSingleSignOnUserSearchResponse(value: object): value is SingleSignOnUserSearchResponse {
    return true;
}

export function SingleSignOnUserSearchResponseFromJSON(json: any): SingleSignOnUserSearchResponse {
    return SingleSignOnUserSearchResponseFromJSONTyped(json, false);
}

export function SingleSignOnUserSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SingleSignOnUserSearchResponse {
    if (json == null) {
        return json;
    }
    return {
