 ...
 */
export function instanceOfCountrySearchResponse(value: object): value is CountrySearchResponse {
    return true;
}

export function CountrySearchResponseFromJSON(json: any): CountrySearchResponse {
    return CountrySearchResponseFromJSONTyped(json, false);
}

export function CountrySearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountrySearchResponse {
    if (json == null) {
        return json;
    }
    return {
