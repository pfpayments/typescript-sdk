 ...
 */
export function instanceOfRefundBankTransactionSearchResponse(value: object): value is RefundBankTransactionSearchResponse {
    return true;
}

export function RefundBankTransactionSearchResponseFromJSON(json: any): RefundBankTransactionSearchResponse {
    return RefundBankTransactionSearchResponseFromJSONTyped(json, false);
}

export function RefundBankTransactionSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RefundBankTransactionSearchResponse {
    if (json == null) {
        return json;
    }
    return {
