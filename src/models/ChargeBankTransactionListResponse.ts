 ...
 */
export function instanceOfChargeBankTransactionListResponse(value: object): value is ChargeBankTransactionListResponse {
    return true;
}

export function ChargeBankTransactionListResponseFromJSON(json: any): ChargeBankTransactionListResponse {
    return ChargeBankTransactionListResponseFromJSONTyped(json, false);
}

export function ChargeBankTransactionListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChargeBankTransactionListResponse {
    if (json == null) {
        return json;
    }
    return {
