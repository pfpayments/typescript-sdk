...
export interface TerminalSearchResponse {
     ...
     * @memberof TerminalSearchResponse
     */
...
/**
 * Check if a given object implements the TerminalSearchResponse interface.
 */
export function instanceOfTerminalSearchResponse(value: object): value is TerminalSearchResponse {
    return true;
}

export function TerminalSearchResponseFromJSON(json: any): TerminalSearchResponse {
    return TerminalSearchResponseFromJSONTyped(json, false);
}

export function TerminalSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TerminalSearchResponse {
    if (json == null) {
        return json;
    }
    return {
