 ...
 */
export function instanceOfChargeAttemptListResponse(value: object): value is ChargeAttemptListResponse {
    return true;
}

export function ChargeAttemptListResponseFromJSON(json: any): ChargeAttemptListResponse {
    return ChargeAttemptListResponseFromJSONTyped(json, false);
}

export function ChargeAttemptListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChargeAttemptListResponse {
    if (json == null) {
        return json;
    }
    return {
