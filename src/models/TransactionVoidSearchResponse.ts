 ...
 */
export function instanceOfTransactionVoidSearchResponse(value: object): value is TransactionVoidSearchResponse {
    return true;
}

export function TransactionVoidSearchResponseFromJSON(json: any): TransactionVoidSearchResponse {
    return TransactionVoidSearchResponseFromJSONTyped(json, false);
}

export function TransactionVoidSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionVoidSearchResponse {
    if (json == null) {
        return json;
    }
    return {
