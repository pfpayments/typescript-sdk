 ...
 */
export function instanceOfChargeAttemptSearchResponse(value: object): value is ChargeAttemptSearchResponse {
    return true;
}

export function ChargeAttemptSearchResponseFromJSON(json: any): ChargeAttemptSearchResponse {
    return ChargeAttemptSearchResponseFromJSONTyped(json, false);
}

export function ChargeAttemptSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChargeAttemptSearchResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(ChargeAttemptFromJSON)),
