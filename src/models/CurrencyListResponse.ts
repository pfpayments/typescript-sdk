 ...
 */
export function instanceOfCurrencyListResponse(value: object): value is CurrencyListResponse {
    return true;
}

export function CurrencyListResponseFromJSON(json: any): CurrencyListResponse {
    return CurrencyListResponseFromJSONTyped(json, false);
}

export function CurrencyListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CurrencyListResponse {
    if (json == null) {
        return json;
    }
    return {
