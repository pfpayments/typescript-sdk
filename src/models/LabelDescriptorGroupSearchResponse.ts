 ...
 * 
 * @export
 * @interface LabelDescriptorGroupSearchResponse
 */
export interface LabelDescriptorGroupSearchResponse {
    /**
     * An array containing the actual response objects.
     * @type {Array<LabelDescriptorGroup>}
     * @memberof LabelDescriptorGroupSearchResponse
     */
 ...
 */
export function instanceOfLabelDescriptorGroupSearchResponse(value: object): value is LabelDescriptorGroupSearchResponse {
    return true;
}

export function LabelDescriptorGroupSearchResponseFromJSON(json: any): LabelDescriptorGroupSearchResponse {
    return LabelDescriptorGroupSearchResponseFromJSONTyped(json, false);
}

export function LabelDescriptorGroupSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LabelDescriptorGroupSearchResponse {
    if (json == null) {
        return json;
    }
    return {
