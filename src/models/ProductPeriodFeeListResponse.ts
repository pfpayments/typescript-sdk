 ...
 * 
 * @export
 * @interface ProductPeriodFeeListResponse
 */
export interface ProductPeriodFeeListResponse {
    /**
     * An array containing the actual response objects.
     * @type {Array<ProductPeriodFee>}
     * @memberof ProductPeriodFeeListResponse
     */
 ...
 */
export function instanceOfProductPeriodFeeListResponse(value: object): value is ProductPeriodFeeListResponse {
    return true;
}

export function ProductPeriodFeeListResponseFromJSON(json: any): ProductPeriodFeeListResponse {
    return ProductPeriodFeeListResponseFromJSONTyped(json, false);
}

export function ProductPeriodFeeListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductPeriodFeeListResponse {
    if (json == null) {
        return json;
    }
    return {
