 ...
 */
export function instanceOfPaymentAdjustmentType(value: object): value is PaymentAdjustmentType {
    return true;
}

export function PaymentAdjustmentTypeFromJSON(json: any): PaymentAdjustmentType {
    return PaymentAdjustmentTypeFromJSONTyped(json, false);
}

export function PaymentAdjustmentTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaymentAdjustmentType {
    if (json == null) {
        return json;
    }
    return {
