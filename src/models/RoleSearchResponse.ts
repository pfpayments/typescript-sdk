 ...
 */
export function instanceOfRoleSearchResponse(value: object): value is RoleSearchResponse {
    return true;
}

export function RoleSearchResponseFromJSON(json: any): RoleSearchResponse {
    return RoleSearchResponseFromJSONTyped(json, false);
}

export function RoleSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoleSearchResponse {
    if (json == null) {
        return json;
    }
    return {
