...
import type { PostFinanceCheckoutSdkException } from "./PostFinanceCheckoutSdkException";
...
export class SdkExceptionErrorCodes {
   ...
   */
  public static is(exception: PostFinanceCheckoutSdkException, errorCode: SdkExceptionErrorCodes): boolean {
