 ...
 * 
 * @export
 * @interface MetricUsageReportListResponse
 */
export interface MetricUsageReportListResponse {
    /**
     * An array containing the actual response objects.
     * @type {Array<SubscriptionMetricUsageReport>}
     * @memberof MetricUsageReportListResponse
     */
 ...
 */
export function instanceOfMetricUsageReportListResponse(value: object): value is MetricUsageReportListResponse {
    return true;
}

export function MetricUsageReportListResponseFromJSON(json: any): MetricUsageReportListResponse {
    return MetricUsageReportListResponseFromJSONTyped(json, false);
}

export function MetricUsageReportListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetricUsageReportListResponse {
    if (json == null) {
        return json;
    }
    return {
