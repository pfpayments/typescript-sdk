 ...
 */
export function instanceOfChargeFlow(value: object): value is ChargeFlow {
    return true;
}

export function ChargeFlowFromJSON(json: any): ChargeFlow {
    return ChargeFlowFromJSONTyped(json, false);
}

export function ChargeFlowFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChargeFlow {
    if (json == null) {
        return json;
    }
    return {
