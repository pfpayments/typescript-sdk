 ...
 */
export function instanceOfDunningCaseSearchResponse(value: object): value is DunningCaseSearchResponse {
    return true;
}

export function DunningCaseSearchResponseFromJSON(json: any): DunningCaseSearchResponse {
    return DunningCaseSearchResponseFromJSONTyped(json, false);
}

export function DunningCaseSearchResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DunningCaseSearchResponse {
    if (json == null) {
        return json;
    }
    return {
