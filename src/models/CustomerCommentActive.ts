 ...
 * 
 * @export
 * @interface CustomerCommentActive
 */
export interface CustomerCommentActive {
    /**
     * The comment's actual content.
     * @type {string}
     * @memberof CustomerCommentActive
     */
    content?: string;
    /**
 ...
 */
export function instanceOfCustomerCommentActive(value: object): value is CustomerCommentActive {
    if (!('version' in value) || value['version'] === undefined) return false;
    return true;
}

export function CustomerCommentActiveFromJSON(json: any): CustomerCommentActive {
    return CustomerCommentActiveFromJSONTyped(json, false);
}

export function CustomerCommentActiveFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerCommentActive {
    if (json == null) {
        return json;
    }
    return {
