...
class StaticValueService {
    ...
    */
    public all (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<StaticValue>;  }> {
        const url: string = '/static-value-service/all';
        let queryParams: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<StaticValue>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<StaticValue>");
    ...
    */
    public read (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: StaticValue;  }> {
        const url: string = '/static-value-service/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: StaticValue;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "StaticValue");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
