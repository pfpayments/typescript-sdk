...
class PaymentMethodService {
    ...
    */
    public all (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<PaymentMethod>;  }> {
        const url: string = '/payment-method/all';
        let queryParams: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<PaymentMethod>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<PaymentMethod>");
    ...
    * @param {*} [options] Override http request options.
    */
    public read (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: PaymentMethod;  }> {
        const url: string = '/payment-method/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: PaymentMethod;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "PaymentMethod");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
