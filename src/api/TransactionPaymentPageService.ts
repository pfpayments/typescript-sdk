...
class TransactionPaymentPageService {
    ...
    */
    public paymentPageUrl (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/transaction-payment-page/payment-page-url';
