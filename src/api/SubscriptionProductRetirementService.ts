...
class SubscriptionProductRetirementService {
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const url: string = '/subscription-product-retirement/count';
        let queryParams: any = {};
    ...
    * @param {*} [options] Override http request options.
    */
    public create (spaceId: number, retirement: SubscriptionProductRetirementCreate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionProductRetirement;  }> {
        const url: string = '/subscription-product-retirement/create';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        if (retirement === null || retirement === undefined) {
            throw new Error('Required parameter retirement was null or undefined when calling create.');
        }
        ...
        return new Promise<{ response: http.IncomingMessage; body: SubscriptionProductRetirement;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "SubscriptionProductRetirement");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    * @param {*} [options] Override http request options.
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionProductRetirement;  }> {
        const url: string = '/subscription-product-retirement/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    * @param {*} [options] Override http request options.
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<SubscriptionProductRetirement>;  }> {
        const url: string = '/subscription-product-retirement/search';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<SubscriptionProductRetirement>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<SubscriptionProductRetirement>");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
...
export { SubscriptionProductRetirementService }
