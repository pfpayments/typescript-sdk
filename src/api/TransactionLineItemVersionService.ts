...
class TransactionLineItemVersionService {
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const localVarPath = this.basePath + '/transaction-line-item-version/count';
    ...
    * @param {*} [options] Override http request options.
    */
    public create (spaceId: number, lineItemVersion: TransactionLineItemVersionCreate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: TransactionLineItemVersion;  }> {
        const localVarPath = this.basePath + '/transaction-line-item-version/create';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
            ...
            // verify required parameter 'lineItemVersion' is not null or undefined
            if (lineItemVersion === null || lineItemVersion === undefined) {
                throw new Error('Required parameter lineItemVersion was null or undefined when calling create.');
            }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(lineItemVersion, "TransactionLineItemVersionCreate"),
        };
    ...
    * @param {*} [options] Override http request options.
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: TransactionLineItemVersion;  }> {
        const localVarPath = this.basePath + '/transaction-line-item-version/read';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    * @param {*} [options] Override http request options.
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<TransactionLineItemVersion>;  }> {
        const localVarPath = this.basePath + '/transaction-line-item-version/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<TransactionLineItemVersion>;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    return reject(error);
                } else {
                    if (response.statusCode){
                        if (response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<TransactionLineItemVersion>");
                            return resolve({ response: response, body: body });
                        } else {
                            let errorObject: ClientError | ServerError;
                            if (response.statusCode >= 400 && response.statusCode <= 499) {
