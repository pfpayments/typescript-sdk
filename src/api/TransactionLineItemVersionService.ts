...
class TransactionLineItemVersionService {
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const url: string = '/transaction-line-item-version/count';
        let queryParams: any = {};
    ...
    */
    public create (spaceId: number, lineItemVersion: TransactionLineItemVersionCreate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: TransactionLineItemVersion;  }> {
        const url: string = '/transaction-line-item-version/create';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: TransactionLineItemVersion;  }> {
        const url: string = '/transaction-line-item-version/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<TransactionLineItemVersion>;  }> {
        const url: string = '/transaction-line-item-version/search';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<TransactionLineItemVersion>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<TransactionLineItemVersion>");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
