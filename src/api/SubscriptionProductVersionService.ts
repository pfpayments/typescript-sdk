...
class SubscriptionProductVersionService {
    ...
    */
    public activate (spaceId: number, productVersionId: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionProductVersion;  }> {
        const url: string = '/subscription-product-version/activate';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);

        // verify required parameter 'spaceId' is not null or undefined
        if (spaceId === null || spaceId === undefined) {
            throw new Error('Required parameter spaceId was null or undefined when calling activate.');
        }

        // verify required parameter 'productVersionId' is not null or undefined
        if (productVersionId === null || productVersionId === undefined) {
            throw new Error('Required parameter productVersionId was null or undefined when calling activate.');
        }
        ...
        if (productVersionId !== undefined) {
            queryParams['productVersionId'] = ObjectSerializer.serialize(productVersionId, "number");
        }
        ...
        return new Promise<{ response: http.IncomingMessage; body: SubscriptionProductVersion;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "SubscriptionProductVersion");
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const url: string = '/subscription-product-version/count';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    * @param {*} [options] Override http request options.
    */
    public create (spaceId: number, entity: SubscriptionProductVersionPending, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionProductVersion;  }> {
        const url: string = '/subscription-product-version/create';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    * @param {*} [options] Override http request options.
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionProductVersion;  }> {
        const url: string = '/subscription-product-version/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    * @param {*} [options] Override http request options.
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<SubscriptionProductVersion>;  }> {
        const url: string = '/subscription-product-version/search';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<SubscriptionProductVersion>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<SubscriptionProductVersion>");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    * @param {*} [options] Override http request options.
    */
    public update (spaceId: number, entity: SubscriptionProductVersionPending, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionProductVersion;  }> {
        const url: string = '/subscription-product-version/update';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
...
export { SubscriptionProductVersionService }
