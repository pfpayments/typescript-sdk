...
class ConditionTypeService {
    ...
    */
    public all (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<ConditionType>;  }> {
        const url: string = '/condition-type/all';
        let queryParams: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<ConditionType>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<ConditionType>");
    ...
    */
    public read (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ConditionType;  }> {
        const url: string = '/condition-type/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: ConditionType;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "ConditionType");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
