...
class SubscriptionProductFeeTierService {
    ...
    */
    public _delete (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const url: string = '/subscription-product-fee-tier/delete';
        let queryParams: any = {};
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const url: string = '/subscription-product-fee-tier/count';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    * @param {*} [options] Override http request options.
    */
    public create (spaceId: number, entity: ProductMeteredTierFeeUpdate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductMeteredTierFee;  }> {
        const url: string = '/subscription-product-fee-tier/create';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: ProductMeteredTierFee;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "ProductMeteredTierFee");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    * @param {*} [options] Override http request options.
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductMeteredTierFee;  }> {
        const url: string = '/subscription-product-fee-tier/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    * @param {*} [options] Override http request options.
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<ProductMeteredTierFee>;  }> {
        const url: string = '/subscription-product-fee-tier/search';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<ProductMeteredTierFee>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<ProductMeteredTierFee>");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    * @param {*} [options] Override http request options.
    */
    public update (spaceId: number, entity: ProductMeteredTierFeeUpdate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductMeteredTierFee;  }> {
        const url: string = '/subscription-product-fee-tier/update';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
...
export { SubscriptionProductFeeTierService }
