...
class DunningCaseService {
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const url: string = '/dunning-case/count';
        let queryParams: any = {};
    ...
    * @summary Create Dunning Case
    * @param spaceId 
    * @param invoiceId ID of the invoice to base the dunning case on.
    * @param {*} [options] Override http request options.
    */
    public createFromInvoice (spaceId: number, invoiceId: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: DunningCase;  }> {
        const url: string = '/dunning-case/create-from-invoice';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);

        // verify required parameter 'spaceId' is not null or undefined
        if (spaceId === null || spaceId === undefined) {
            throw new Error('Required parameter spaceId was null or undefined when calling createFromInvoice.');
        }

        // verify required parameter 'invoiceId' is not null or undefined
        if (invoiceId === null || invoiceId === undefined) {
            throw new Error('Required parameter invoiceId was null or undefined when calling createFromInvoice.');
        }
        ...
        return new Promise<{ response: http.IncomingMessage; body: DunningCase;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "DunningCase");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    * @param {*} [options] Override http request options.
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: DunningCase;  }> {
        const url: string = '/dunning-case/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    * @param {*} [options] Override http request options.
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<DunningCase>;  }> {
        const url: string = '/dunning-case/search';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<DunningCase>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<DunningCase>");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    * @summary Suspend Dunning Case
    * @param spaceId 
    * @param id ID of the dunning case to suspend.
    * @param plannedEndDate Optional planned end date of the suspension.
    * @param {*} [options] Override http request options.
    */
    public suspend (spaceId: number, id: number, plannedEndDate?: Date, options: any = {}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const url: string = '/dunning-case/suspend';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        if (plannedEndDate !== undefined) {
            queryParams['plannedEndDate'] = ObjectSerializer.serialize(plannedEndDate, "Date");
        }
