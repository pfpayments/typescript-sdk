...
class ShopifySubscriptionSuspensionService {
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const url: string = '/shopify-subscription-suspension/count';
        let queryParams: any = {};
    ...
    */
    public reactivate (spaceId: number, subscriptionId: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const url: string = '/shopify-subscription-suspension/reactivate';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ShopifySubscriptionSuspension;  }> {
        const url: string = '/shopify-subscription-suspension/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: ShopifySubscriptionSuspension;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "ShopifySubscriptionSuspension");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<ShopifySubscriptionSuspension>;  }> {
        const url: string = '/shopify-subscription-suspension/search';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<ShopifySubscriptionSuspension>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<ShopifySubscriptionSuspension>");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    */
    public suspend (spaceId: number, suspension: ShopifySubscriptionSuspensionCreate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ShopifySubscriptionSuspension;  }> {
        const url: string = '/shopify-subscription-suspension/suspend';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
