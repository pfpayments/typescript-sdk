...
class ShopifySubscriptionProductService {
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const url: string = '/shopify-subscription-product/count';
        let queryParams: any = {};
    ...
    * @param {*} [options] Override http request options.
    */
    public create (spaceId: number, entity: ShopifySubscriptionProductCreate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ShopifySubscriptionProduct;  }> {
        const url: string = '/shopify-subscription-product/create';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: ShopifySubscriptionProduct;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "ShopifySubscriptionProduct");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    * @param {*} [options] Override http request options.
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ShopifySubscriptionProduct;  }> {
        const url: string = '/shopify-subscription-product/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    * @param {*} [options] Override http request options.
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<ShopifySubscriptionProduct>;  }> {
        const url: string = '/shopify-subscription-product/search';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<ShopifySubscriptionProduct>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<ShopifySubscriptionProduct>");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    */
    public update (spaceId: number, entity: ShopifySubscriptionProductUpdate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ShopifySubscriptionProduct;  }> {
        const url: string = '/shopify-subscription-product/update';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
...
export { ShopifySubscriptionProductService }
