...
class SubscriptionSuspensionService {
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const url: string = '/subscription-suspension/count';
        let queryParams: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: SubscriptionSuspension;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "SubscriptionSuspension");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionSuspension;  }> {
        const url: string = '/subscription-suspension/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<SubscriptionSuspension>;  }> {
        const url: string = '/subscription-suspension/search';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<SubscriptionSuspension>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<SubscriptionSuspension>");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    */
    public terminate (suspensionId: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionSuspension;  }> {
        ...
        if (suspensionId !== undefined) {
            queryParams['suspensionId'] = ObjectSerializer.serialize(suspensionId, "number");
        }
