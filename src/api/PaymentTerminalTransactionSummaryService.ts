...
class PaymentTerminalTransactionSummaryService {
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const url: string = '/payment-terminal-transaction-summary/count';
        let queryParams: any = {};
    ...
    */
    public fetchReceipt (spaceId: number, request: PaymentTerminalTransactionSummaryFetchRequest, options: any = {}) : Promise<{ response: http.IncomingMessage; body: RenderedTerminalTransactionSummary;  }> {
        const url: string = '/payment-terminal-transaction-summary/fetch-receipt';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: RenderedTerminalTransactionSummary;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "RenderedTerminalTransactionSummary");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: PaymentTerminalTransactionSummary;  }> {
        const url: string = '/payment-terminal-transaction-summary/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: PaymentTerminalTransactionSummary;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "PaymentTerminalTransactionSummary");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<PaymentTerminalTransactionSummary>;  }> {
        const url: string = '/payment-terminal-transaction-summary/search';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<PaymentTerminalTransactionSummary>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<PaymentTerminalTransactionSummary>");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
