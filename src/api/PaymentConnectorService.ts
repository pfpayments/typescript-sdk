...
class PaymentConnectorService {
    ...
    */
    public all (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<PaymentConnector>;  }> {
        const url: string = '/payment-connector/all';
        let queryParams: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<PaymentConnector>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<PaymentConnector>");
    ...
    */
    public read (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: PaymentConnector;  }> {
        const url: string = '/payment-connector/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: PaymentConnector;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "PaymentConnector");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
