...
class LegalOrganizationFormService {
    ...
    */
    public all (options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<LegalOrganizationForm>;  }> {
        const url: string = '/legal-organization-form/all';
        let queryParams: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<LegalOrganizationForm>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<LegalOrganizationForm>");
    ...
    * @param {*} [options] Override http request options.
    */
    public country (code: string, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<LegalOrganizationForm>;  }> {
        const url: string = '/legal-organization-form/country';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        if (code !== undefined) {
            queryParams['code'] = ObjectSerializer.serialize(code, "string");
        }
    ...
    * @param {*} [options] Override http request options.
    */
    public read (id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: LegalOrganizationForm;  }> {
        const url: string = '/legal-organization-form/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: LegalOrganizationForm;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "LegalOrganizationForm");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
