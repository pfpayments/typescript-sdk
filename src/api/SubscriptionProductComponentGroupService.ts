...
class SubscriptionProductComponentGroupService {
    ...
    */
    public _delete (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const url: string = '/subscription-product-component-group/delete';
        let queryParams: any = {};
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const url: string = '/subscription-product-component-group/count';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    * @param {*} [options] Override http request options.
    */
    public create (spaceId: number, entity: SubscriptionProductComponentGroupUpdate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionProductComponentGroup;  }> {
        const url: string = '/subscription-product-component-group/create';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: SubscriptionProductComponentGroup;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "SubscriptionProductComponentGroup");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    * @param {*} [options] Override http request options.
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionProductComponentGroup;  }> {
        const url: string = '/subscription-product-component-group/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    * @param {*} [options] Override http request options.
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<SubscriptionProductComponentGroup>;  }> {
        const url: string = '/subscription-product-component-group/search';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<SubscriptionProductComponentGroup>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<SubscriptionProductComponentGroup>");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    * @param {*} [options] Override http request options.
    */
    public update (spaceId: number, entity: SubscriptionProductComponentGroupUpdate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: SubscriptionProductComponentGroup;  }> {
        const url: string = '/subscription-product-component-group/update';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
...
export { SubscriptionProductComponentGroupService }
