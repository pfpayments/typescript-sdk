...
class SubscriptionProductSetupFeeService {
    ...
    */
    public _delete (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const url: string = '/subscription-product-setup-fee/delete';
        let queryParams: any = {};
    ...
    */
    public count (spaceId: number, filter?: EntityQueryFilter, options: any = {}) : Promise<{ response: http.IncomingMessage; body: number;  }> {
        const url: string = '/subscription-product-setup-fee/count';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    */
    public create (spaceId: number, entity: ProductSetupFeeUpdate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductSetupFee;  }> {
        const url: string = '/subscription-product-setup-fee/create';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: ProductSetupFee;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "ProductSetupFee");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    */
    public read (spaceId: number, id: number, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductSetupFee;  }> {
        const url: string = '/subscription-product-setup-fee/read';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
    ...
    */
    public search (spaceId: number, query: EntityQuery, options: any = {}) : Promise<{ response: http.IncomingMessage; body: Array<ProductSetupFee>;  }> {
        const url: string = '/subscription-product-setup-fee/search';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<ProductSetupFee>;  }>((resolve, reject) => {
            axiosInstance.request(requestConfig)
                .then(
                    success => {
                        let body;
                        body = ObjectSerializer.deserialize(success.data, "Array<ProductSetupFee>");
                        return resolve({ response: success.request.res, body: body });
                    },
                    failure => {
                        let errorObject: ClientError | ServerError | Object;
    ...
    */
    public update (spaceId: number, entity: ProductSetupFeeUpdate, options: any = {}) : Promise<{ response: http.IncomingMessage; body: ProductSetupFee;  }> {
        const url: string = '/subscription-product-setup-fee/update';
        let queryParams: any = {};
        let headers: any = Object.assign({}, this._defaultHeaders);
...
export { SubscriptionProductSetupFeeService }
