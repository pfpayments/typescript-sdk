    ...
    describe('search', () => {
        it('search success', () => {
            ...
            transactionService.create(config.space_id, getTransactionPayload())
                ...
                .then((response: { response: http.IncomingMessage, body: Array<PostFinanceCheckout.model.Transaction> }) => {
    ...
    describe('update', () => {
        it('update success',  () => {
            transactionService.create(config.space_id, getTransactionPayload())
                .then((response: { response: http.IncomingMessage, body: PostFinanceCheckout.model.Transaction }) => {
                    let transaction: PostFinanceCheckout.model.Transaction = response.body;
                    let transactionPending: PostFinanceCheckout.model.TransactionPending = new PostFinanceCheckout.model.TransactionPending();
